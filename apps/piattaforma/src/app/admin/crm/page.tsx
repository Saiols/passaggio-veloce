  ...
  return (
    <AppShell session={session!} activePath="/admin/crm">
      <div className="mx-auto w-full max-w-6xl px-5 py-8 sm:px-6 sm:py-10">
        <header className="mb-7 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-[13px] text-pv-slate-500">
              Punto di accesso al modulo CRM. Catalogo contatti dedupli­cato +
              dashboard relazionale completa (in arrivo).
            </p>
          </div>
          <a
            href={exportHref}
        ...
        {/* Item 18 release 2026-05: placeholder verso CRM nativo (FASE 14
            differita per decisione D-03). La pagina espone gia' il catalogo
            contatti deduplicato; la dashboard CRM completa arrivera' nella
            FASE 14 con automazioni Sales Agent, multi-canale, chatbot. */}
        <Card className="mb-6 border-pv-amber-500/30 bg-pv-amber-50/40">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="text-[11px] font-bold uppercase tracking-wider text-pv-amber-500">
                Coming soon
              </p>
              <h2 className="mt-1 text-[15px] font-bold text-pv-navy-800">
                Dashboard CRM completa
              </h2>
              <p className="mt-1 text-[12.5px] text-pv-slate-700">
                Pipeline lead, funnel S0-S10, Sales Agent Vapi, automazioni
                multi-canale e chatbot in arrivo nella FASE 14.
              </p>
            </div>
            <span className="inline-flex shrink-0 items-center rounded-full bg-pv-amber-500/15 px-3 py-1 text-[11px] font-bold uppercase tracking-wider text-pv-amber-500">
              FASE 14
            </span>
          </div>
        </Card>
