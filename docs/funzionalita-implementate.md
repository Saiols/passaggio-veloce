...
- **Orario piattaforma** (`lib/distribuzione/orario-piattaforma.ts` + `ore-lavorative.ts`): l'espansione del raggio gira solo **lun-ven 09:00-19:00**; la notte è in pausa e riprende la mattina dal raggio salvato. Il **primo** round ignora l'orario (parte a qualsiasi ora).
